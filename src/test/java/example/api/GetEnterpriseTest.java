...
import net.ats.api.asserts.AssertResult;
import net.ats.api.asserts.Asserts;
...
public class GetEnterpriseTest{
    ...
    /********** test method ***********/
    @Test(groups={"SMOKE"}, dataProvider="defaultMethod", dataProviderClass=DataProviderClass.class)
