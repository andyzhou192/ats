package net.ats.api.protocol.httpclient;
...
public class HttpClientImpl extends AbstractHttpClient {
	...
	/**
	 * 
	 * @param uri  请求地址，如：http://10.10.10.10/ems/new/get
	 * @param headers  请求头信息（请求头之间以\r\n分隔），如：Connection: keep-alive\r\nContent-Type: application/x-www-form-urlencoded\r\nContent-Length: 52\r\nHost: 10.10.10.10\r\nUser-Agent: Apache-HttpClient/4.5.2 (Java/1.8.0_111)
	 * @param params   请求参数（参数之间以&分隔），如：loginName=123456&loginPassword=123456789&type=1
	 */
	public HttpClientImpl(String uri, String headers, String params){
		this.uri = uri;
		this.headers = super.getHeaders(headers, Consts.LF);
		this.params = params;
	}
	 ...
	 * @param headers  请求头信息（请求头之间以\r\n分隔），如：Connection: keep-alive\r\nContent-Type: application/x-www-form-urlencoded\r\nContent-Length: 52\r\nHost: 10.10.10.10\r\nUser-Agent: Apache-HttpClient/4.5.2 (Java/1.8.0_111)
	 * @param params   请求参数（参数之间以&分隔），如：loginName=123456789&loginPassword=123456789&type=1
	 * @param cookieStore
	 */
...
////////////////////////// below methods are http request methods //////////////////////////////////////
	...
	public HttpResponse doPut() throws ClientProtocolException, IOException{
		...
		httpPut.setEntity(getHttpEntity(params, Consts.AND));
	...
	public HttpResponse doPost() throws ClientProtocolException, IOException{
        ...
        httpPost.setEntity(getHttpEntity(params, Consts.AND));
...
////////////////////////// below methods are file upload and file download //////////////////////////////////////
	...
	public HttpResponse uploadFile(String file, String desc) throws ClientProtocolException, IOException{
        ...
        for(String param:params.split(Consts.AND)){
